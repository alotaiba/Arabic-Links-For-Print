Arabic Links for Print, is a jQuery plugin, that improves the printed Arabic web pages, by collecting all the links found on the page, and placing them on the bottom of the page (footnote).
